...
def parse_command():
    ...
    camera_names = ['kinect', 'webcam','record']
    ...
    parser.add_argument('-t','--test', dest = 'test', action='store_true',
                        help='test the model on live image, press esc to exit')
    parser.add_argument('--camera', dest = 'camera', metavar='CAMERA', default='webcam', choices=camera_names,
                        help='camera: ' + ' | '.join(camera_names) + ' (default: webcam)')
    parser.add_argument('-recorddata', dest='recorddata', action='store_true',
                        help='test the model on record image')
    parser.add_argument('--kinectdata', dest = 'kinectdata', metavar='NAME', default='None',
                        help='the file name of the input pickle file')
    parser.add_argument('-ss', '--sample-spacing', default=0, type=int, metavar='N',
                        help='number of sparse depth samples (default: 0)')
    parser.add_argument('-w', '--write', dest='write', action='store_true',
                        help='write image to folder')
